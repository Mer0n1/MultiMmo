...
protected:
	...
	VidE - функция движения. Основная задача - задать какой то алгоритм движения существующей атаки. Тип VidE - номер алгоритма
	1. Атака движется от позиции игрока до место клика мышки
	2. Атака создается рандомно в зоне вокруг противника и движется в его сторону
	3. Атака преследует противника
	4. Атака движется по окружности
